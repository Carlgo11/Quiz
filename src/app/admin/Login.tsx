    ...
    return (
            <div className={styles.outerForm}>
                <form className="col col-md-8 col-lg-6" onSubmit={
                    ...
                    <hr/>
                    <input name="username" type="username" className="form-control mb-2" placeholder={tr.username} required maxLength={16} pattern="[A-z0-9]{1,16}" title="Only letters and numbers allowed"/>
